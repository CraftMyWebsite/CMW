...
<?php for($i = 0; $i < count($membres); $i++) { ?>
	<tr class="ligneMembres" style="max-width: 100%;">
	    ...
	    <td>
				...
				<option <?php if($membres[$i]['rang'] == 1) { echo 'selected'; }?>>Créateur
				<option <?php if($membres[$i]['rang'] == 2) { echo 'selected'; }?>>Administrateur
				<option <?php if($membres[$i]['rang'] == 3) { echo 'selected'; }?>>Modérateur
				<option <?php if($membres[$i]['rang'] == 4) { echo 'selected'; }?>>Développeur
				<option <?php if($membres[$i]['rang'] == 5) { echo 'selected'; }?>>Buildeur
				</select>
		</td>
	    <td>
