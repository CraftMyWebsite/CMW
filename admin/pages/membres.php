                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <h5>Nombre de membres/pages: <input style="margin-top:3px;" type="number"
                                                                ...
                                                                max="<?php echo count($membres); ?>" step="1"
                            ...
                            <div class="alert alert-success">
                                <div class="text-center">
                                    <p>
                                        ...
                                        pour obtenir une recherche plus avancée / conforme à vos attentes.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped table-hover table-responsive">
                            ...
                            <tr>
                                ...
                                <th style="cursor:pointer;"
                                    onclick="setAxe('tokens');"><?= $_Serveur_['General']['moneyName']; ?></th>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="from-group" style="display: block !important">
                                <button class="btn btn-success w-100" id="confirm-change" onclick="sendChange()"
                                        disabled>Modifier le / les comptes
                                </button>
                            </div>
                        </div>
