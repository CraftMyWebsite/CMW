                ...
                <div class="card">
                    ...
                    <div class="card-body" id="addPref">
                        ...
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixPrimary"
                                   value="prefixPrimary" checked>
                            <span class="prefix prefixPrimary" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixSecondary"
                                   value="prefixSecondary">
                        ...
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixGreen"
                                   value="prefixGreen">
                            <span class="prefix prefixGreen" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixOlive"
                                   value="prefixOlive">
                            <span class="prefix prefixOlive" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixLightGreen"
                                   value="prefixLightGreen">
                            <span class="prefix prefixLightGreen" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixBlue"
                                   value="prefixBlue">
                            <span class="prefix prefixBlue" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixRoyalBlue"
                                   value="prefixRoyalBlue">
                            <span class="prefix prefixRoyalBlue" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixSkyBlue"
                                   value="prefixSkyBlue">
                            <span class="prefix prefixSkyBlue" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixGray"
                                   value="prefixGray">
                            <span class="prefix prefixGray" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixSilver"
                                   value="prefixSilver">
                            <span class="prefix prefixSilver" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixYellow"
                                   value="prefixYellow">
                            <span class="prefix prefixYellow" style="height: 10px; width: 15px;"></span>
                        </label>
                        <label class="checkbox-inline">
                            <input class="form-check-input" type="radio" name="prefix" id="prefixOrange"
                                   value="prefixOrange">
                            <span class="prefix prefixOrange" style="height: 10px; width: 15px;"></span>
                        </label>
                    </div>
                    <script>initPost("addPref", "admin.php?action=addPrefix", function (data) {
                            if (data) {
                                let st = "";
                                st += "<tr>";
                    ...
                    <div class="card-footer">
                        <div class="row text-center">
                            <input type="submit" onclick="sendPost('addPref');" class="btn btn-success w-100"
                                   value="Modifier !"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover">
                            ...
                            while ($data = $reqPrefix->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <td><?= $data['nom']; ?></td>
                                <td><span class="<?php echo $data['span']; ?>"
                                          style="height: 10px; width: 20px;"></span></td>
                                <td><span class="<?= $data['span']; ?>"><?= $data['nom']; ?></span></td>
                                <td>
                                    <button onclick="sendDirectPost('admin.php?action=supprPrefix&id=<?= $data['id']; ?>', function(data) { if(data) { hide('prefix<?= $data['id']; ?>')}});"
