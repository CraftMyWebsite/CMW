                            ...
                            <ul class="nav nav-tabs">
                                <?php for ($i = 0; $i < count($tableauNews); $i++) { ?>
                                    <li class="nav-item" id="tabnews-<?php echo $tableauNews[$i]['id']; ?>"><a
                                                ...
                                                style="color: black !important"><?php echo $tableauNews[$i]['titre']; ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                            <div class="tab-content">
                                <?php for ($i = 0; $i < count($tableauNews); $i++) { ?>
                                    <div class="tab-pane well <?php if ($i == 0) echo 'active'; ?>"
                                        ...
                                        <div data-callback="news-<?php echo $tableauNews[$i]['id']; ?>"
                                             data-url="admin.php?action=editNews&id=<?php echo $tableauNews[$i]['id']; ?>"></div>
                                        <script>
