...
<?php if (!$_Permission_->verifPerm('PermsPanel', 'info', 'stats', 'members', 'showPage')) {
    ...
    <div class="alert alert-success">
        <strong>Sur cette section, vous pouvez gérer le système de limitation de comptes par IP, et la vérification lors
            de l'inscription de l'email</strong>
    </div>
    <div class="row"><?php
                ...
                <div class="col-md-12 col-xl-6 col-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="ip<?php echo $nbrPerIP[$i]['id']; ?>">
                            ...
                            <label class="control-label" for="nbrPerIP">Modifiez ici le nombres <span
                                        style="color: red;">limite</span> d'inscriptions par IP. (Entrez -1 pour <span
                                        style="color: green">illimité</span>)</label>
                            <input type="number" style="text-align: center;" name="nbrPerIP" id="nbrPerIP"
                                   class="form-control" placeholder="1"
                                   value="<?php echo $nbrPerIP[$i]['nbrPerIP']; ?>"/>
                        </div>
                        ...
                        <div class="card-footer">
                            <div class="text-center">
                                <input type="submit" onclick="sendPost('ip<?php echo $nbrPerIP[$i]['id']; ?>');"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2" <?php if ($sysMail[$i]['etatMail'] == '1') {
                                echo 'style="display:none;"';
                            } ?>id="active<?php echo $sysMail[$i]['idMail']; ?>">
                  ...
                  L'API est actuellement désactivée.
                            ...
                            <div class="col-md-8 offset-md-2" <?php if ($sysMail[$i]['etatMail'] == '0') {
                                echo 'style="display:none;"';
                            } ?>id="desact<?php echo $sysMail[$i]['idMail']; ?>">
                  ...
                  L'API est actuellement activé.
                            ...
                            <div class="col-md-12 text-center" id="switch<?php echo $sysMail[$i]['idMail']; ?>">
                                ...
                                <input type="hidden" value="<?php if ($sysMail[$i]['etatMail'] == '0') {
                                    echo '1';
                                } else {
                                    echo '0';
                                } ?>" id="value-<?php echo $sysMail[$i]['idMail']; ?>" name="etatMail"/>
                                <button type="submit" id="btn-<?php echo $sysMail[$i]['idMail']; ?>"
                                        onclick="sendPost('switch<?php echo $sysMail[$i]['idMail']; ?>');"
                                        class="btn btn-<?php if ($sysMail[$i]['etatMail'] == '1') {
                                            echo 'success';
                                        } else {
                                            echo 'danger';
                                        } ?> center-block w-50"/>
                                <?php if ($sysMail[$i]['etatMail'] == '1') {
                                    echo 'Activer';
                                } else {
                                    echo 'Désactiver';
                                } ?></button>
                                <script>initPost("switch<?php echo $sysMail[$i]['idMail']; ?>", "admin.php?&action=switchSysMail&idMail=<?php echo $sysMail[$i]['idMail']; ?>", function (data) {
                                        if (data) {
                        ...
                        <div class="card-body" id="editSysMail&idMail=<?php echo $sysMail[$i]['idMail']; ?>">
                            <div class="container-fluid">
                                ...
                                <label class="control-label">Modifiez ici le nombres <span
                                            style="color: red;">limite</span>
                                    d'utilisation d'une email par compte.</label>
                                <input type="number" style="text-align: center;" name="strictMail" class="form-control"
                                       placeholder="1"
                                       value="<?php echo $sysMail[$i]['strictMail']; ?>">

                                <hr/>
                                <div class="row">
                                    <a class="btn btn-info w-100 text-center" data-toggle="collapse"
                                       href="#editContentapi" role="button" aria-expanded="false"
                                       aria-controls="editContentapi">
                                ...
                                <div class="collapse" id="editContentapi">
                                    ...
                                    <div class="alert alert-success">
                                        ...
                                        <p>
                                            Voici les variables disponible pour customisé le mail de validation /
                                            bienvenue :<br>
                                        <ul>
                                            <li>
                                                <code>{LIEN}</code> equivaut et affichera le lien pour confirmer
                                                l'inscription ( <span
                                ...
                                &nbsp;</span> ) <i class="fas fa-exclamation-circle"></i>
                                            ...
                                            <li>
                                                <code>{IP}</code> equivaut et affichera l'adresse ip enregistrer à
                                                l'inscription
                                            </li>
                                        </ul>
                                        </p>
                                    ...
                                    <input type="text" style="text-align: center;" class="form-control" name="fromMail"
                                           value="<?php echo $sysMail[$i]['fromMail']; ?>" id="fromMail"
                                           placeholder="no-reply@infectedz.fr">
                                    ...
                                    <input type="text" style="text-align: center;" class="form-control" name="sujetMail"
                                           value="<?php echo $sysMail[$i]['sujetMail']; ?>" id="sujetMail"
                                           placeholder="Votre lien d'activation !">
                        ...
                        <div class="card-footer">
                            <div class="row text-center">
                                <input type="submit"
                                       onclick="sendPost('editSysMail&idMail=<?php echo $sysMail[$i]['idMail']; ?>');"
                                       class="btn btn-success w-100" value="Valider"/>
                            </div>
                        </div>
                    </div>
                </div>
