                                        ...
                                        <div class="col-md-12" id="fich<?php echo $j; ?>">
                                            ...
                                            <div class="card">
                                                <div class="card-header" style="cursor:pointer;"
                                                     onclick="SwitchDisplay(get('fich2<?= $j ?>'));">
                                                    <div style="width: 100%;display: inline-block">
                                                        ...
                                                        <div class="float-right">
                                                            <button onclick="sendDirectPost('admin.php?action=supprUpload&file=<?php echo $fichier; ?>', function(data) { if(data) { hide('fich<?php echo $j; ?>'); } });"
                                                ...
                                                <div class="card-body text-center" style="display:none;"
                                                     id="fich2<?= $j ?>">
                                                    <img src="./theme/upload/panel/<?= $fichier ?>"
                                                         alt="<?= $fichier ?>" class="img-fluid">
                                                    <br>
                                                    <div class="well mt-3">
                                                        <p class="pt-2">
                                                            <?= (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] ?>
                                                            /theme/upload/panel/<?= $fichier ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group w-100">
                                <div class="input-group file-input-group" style="margin-top:10px;">
                                    <input class="form-control" id="img-text" type="text"
