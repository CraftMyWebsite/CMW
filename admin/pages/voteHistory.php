        ...
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><strong>Configurer la liste des voteurs</strong> <small id="infoState">(Croissant
                            sur
                            nombre)</small></h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <h5 style="margin-top:20px;">Rechercher un voteur: <input style="margin-top:3px;"
                                                                                      type="text"
                                                                                      onkeyup="updateList();"
                                                                                      id="input-search"
                ...
                <div class="card-header">
                    <div style="width: 100%;display: inline-block">
                        ...
                        <div class="float-right">
                            <button onclick="sendDirectPost('admin.php?action=suppAllVoteHistory', function(data) { if(data) { hide('allUser'); } });"
                                    class="btn btn-sm btn-outline-secondary">Rénitialiser
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th style="cursor:pointer;" onclick="setAxe('nombre');">Nombre de votes (total: <span
                                            id="countall"><?= $countall ?></span>)
                                </th>
                            </tr>
                            </thead>
                            <tbody id="allUser">
                ...
                <div class="card">
                    <div class="card-header">
                        <div style="width: 100%;display: inline-block">
                            ...
                            <div class="float-right">
                                <button onclick="sendDirectPost('admin.php?action=suppAllOldVoteHistory', function(data) { if(data) { hide('allUser'); } });"
                                        class="btn btn-sm btn-outline-secondary">Rénitialiser
                                </button>
                            </div>
                        </div>
