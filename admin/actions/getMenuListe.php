        ...
        foreach ($menu as $value) {
            if ($value['dest'] == -1) { ?>
                <li class="nav-item" id="tabmenu-<?php echo $value['id']; ?>">
                    <a id="tab2menu-<?php echo $value['id']; ?>" class="<?php if ($first) echo 'active'; ?> nav-link"
                ...
                <div class="tab-pane well <?php if ($i == 0) echo 'active'; ?>" id="menu-<?php echo $value['id']; ?>">
                            ...
                            foreach ($value['list'] as $value2) { ?>
                                <li class="nav-item" id="tabmenu-dest-<?php echo $value2['id']; ?>">
                                    <a id="tab2menu-dest-<?php echo $value2['id']; ?>"
                                       ...
                                       href="#menu-dest-<?php echo $value2['id']; ?>" data-toggle="tab"
                                       style="color: black !important"><?php echo $value2['name']; ?></a></li>
                                <?php $first = false;
                            } ?>
                        </ul>
                        <div class="tab-content">
                                ...
                                <div class="tab-pane well <?php if ($u == 0) echo 'active'; ?>"
                                    ...
                                    <div style="width: 100%;display: inline-block">
                                        ...
                                        <div class="float-right">
                                            <button <?php if ($u == 0) {
                                                echo 'style="display:none;"';
                                            } ?> id="tabmenu-dest-<?php echo $value2['id']; ?>-up" type="button"
                                            ...
                                            <button <?php if ($u == count($value['list']) - 1) {
                                                echo 'style="display:none;"';
                                            } ?> id="tabmenu-dest-<?php echo $value2['id']; ?>-down" type="button"
                                    ...
                                    <select name="methode-dest<?php echo $value2['id']; ?>" class="form-control"
                                            onclick="
                                    ...
                                    <div id="typeLien-dest-2-<?php echo $value2['id']; ?>" <?php echo $isPage2 ? 'style="display:none;"' : ''; ?>>
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $value2['url']; ?>"
                    ...
                    <?php } else { ?>
                        ...
                        <div id="typeLien-2-<?php echo $value['id']; ?>" <?php echo $isPage ? 'style="display:none;"' : ''; ?>>
                            <label class="control-label">Lien</label>
                            <input type="text" class="form-control" value="<?php echo $value['url']; ?>" name="lien"
                                   placeholder="ex: http://minecraft.net/">
                        </div>
                    ...
                    <div data-callback="menu-<?php echo $value['id']; ?>"
                         data-url="admin.php?&action=editMenu&id=<?php echo $value['id']; ?>"></div>
                    <div class="card-footer" style="background-color:rgba(0,0,0,0);">
                        <div class="text-center">
                            <input type="submit" onclick="sendPost('menu-<?php echo $value['id']; ?>');"
