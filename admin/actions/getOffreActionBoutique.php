    ...
    <?php if (!empty($actions)) {
        for ($k = 0; $k < count($actions); $k++) {
            if ($actions[$k]['id_offre'] == $_GET['id']) { ?>
                <div data-callback="allaction-<?php echo $_GET['id']; ?>"
                ...
                <div class="col-md-12 col-lg-5" style="margin-top:10px;">
                    <?php if ($actions[$k]['methode'] == 6) { ?>
                        <select class="form-control" name="commandeValeur-<?php echo $actions[$k]['id']; ?>">
                            ...
                            <?php } ?>
                            <option value="1" <?php if ($actions[$k]['grade'] == 1) echo 'selected'; ?>>Créateur
                            </option>
                        </select>
                    <?php } else { ?>
                        <input name="commandeValeur-<?php echo $actions[$k]['id']; ?>" class="form-control"
