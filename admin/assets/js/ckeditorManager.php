<script>
    ...
    function initCK() {
        ...
        for (let el of document.querySelectorAll("[data-UUID]")) {
                ...
                option = {
                    toolbar: {
                        items: [
                            ...
                            'numberedList',
                            '|',
                            <?php if (isset($_Serveur_['uploadImage']) && isset($_Serveur_['uploadImage']['maxFileSize']) && isset($_Serveur_['uploadImage']['maxSize'])) {
                            echo "'uploadImage',";
                        }  ?>
                            'blockQuote',
                            'mediaEmbed',
            ...
            ClassicEditor.create(el, option).catch(error => {
                console.log(error);
            })
                .then(editor => {
                    CK.set(el, editor);
