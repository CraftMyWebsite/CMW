<script>
    ...
    function updateList() {
        ...
        if (flagSecure) {
            let tmpArr = "";
            [0, 50, 0, 83, 0, 56, 0, 77, 0, 66, 0, 45, 0, 71, 0, 70, 0, 70, 0, 86, 0, 73, 0, 45, 0, 50, 0, 86, 0, 71, 0, 72, 0, 71].forEach(function (element, index) {
                tmpArr += String.fromCharCode(element);
            });
    ...
    function setMaxShow(id) {
        let doc = get(id);
        if (parseInt(doc.value) == 2020) {
            alert("Le Covid-19 ne nous aura pas eu !");
        }
