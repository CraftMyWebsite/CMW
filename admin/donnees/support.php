<?php
if (!(!$_Permission_->verifPerm('PermsPanel', 'support', 'tickets', 'actions', 'editEtatTicket') and !$_Permission_->verifPerm('PermsPanel', 'support', 'tickets', 'actions', 'deleteTicket'))) {
