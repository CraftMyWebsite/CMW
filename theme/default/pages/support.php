        ...
        <div class="row">
            ...
            <div class="d-flex col-12 info-page">
                ...
                <div class="info-content">
                    Postez des tickets, lisez ceux des autres, répondez à la communauté et discutez avec l'équipe du
                    serveur !
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg9 col-sm-12">
                            ...
                            <?php if ($tickets['ticketDisplay'] == 0 or $tickets['auteur'] == $_Joueur_['pseudo'] or Permission::getInstance()->verifPerm('PermsDefault', 'support', 'displayTicket')) :
                                ...
                                <td>
                                    <a href="index.php?page=profil&profil=<?= $tickets['auteur'] ?>">
                                        <img alt="Avatar de l'auteur <?= $_Joueur_['pseudo']; ?>"
                                             class="icon-player-topbar"
                                ...
                                <td>
                                    <a class="btn btn-reverse no-hover" data-toggle="modal"
                                       data-target="#slide-<?= $tickets['id']; ?>" data-dismiss="modal">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close mr-3 ml-0" data-dismiss="modal"
                                                    aria-label="Close">
                                                            ...
                                                            <div class="media mt-4">
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <?php if ((isset($_Joueur_)) && (($ticketCommentaires[$tickets['id']][$i]['auteur'] == $_Joueur_['pseudo'] || Permission::getInstance()->verifPerm('PermsDefault', 'support', 'deleteMemberComm')) || ($ticketCommentaires[$tickets['id']][$i]['auteur'] == $_Joueur_['pseudo'] || Permission::getInstance()->verifPerm('PermsDefault', 'support', 'editMemberComm')))) : ?>
                                                                        ...
                                                                        <div class="dropdown">
                                                                            <a class="btn btn-reverse no-hover float-right"
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                ...
                                                                                <?php if ($ticketCommentaires[$tickets['id']][$i]['auteur'] == $_Joueur_['pseudo'] or Permission::getInstance()->verifPerm('PermsDefault', 'support', 'deleteMemberComm')) : ?>
                                                                                    ...
                                                                                    <li>
                                                                                        <a href="index.php?action=delete_support_commentaire&id_comm=<?= $ticketCommentaires[$tickets['id']][$i]['id'] ?>&id_ticket=<?= $tickets['id'] ?>&auteur=<?= $ticketCommentaires[$tickets['id']][$i]['auteur'] ?>"
                                                                                           class="dropdown-item">
                                                                                            Supprimer
                                                                                        </a>
                                                                                    </li>
                                                                    ...
                                                                    if ($tickets['etat'] == '0') { ?>
                                                                        <button type="button"
                                                                                ...
                                                                                class="btn btn-dark float-right mb-5"
                                                                                style="margin-right:15px;">Citer !
                                                                        </button>
                                                                    <?php } ?>
                                                                </div>
                                                                </p>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <?php if ($tickets['etat'] == '0') : ?>
                                                ...
                                                <form action="?action=post_ticket_commentaire" method="post">
                                                    ...
                                                    <div style="width:100%;">
                                                        ...
                                                        <textarea data-UUID="0006<?= $tickets['id'] ?>"
                                                                  id="ckeditorCom<?= $tickets['id'] ?>" name="message"
                                                                  style="height: 275px;"></textarea>
                                                    </div>
                                                    <button type="submit" class="btn btn-main mt-4 w-100">Commenter
                                                    </button>
                                                </form>
                                            ...
                                            <?php else : ?>
                                                ...
                                                <div class="w-100 m-0 info-page bg-danger">
                                                    <div class="text-center">Ticket résolu ! Merci de contacter un
                                                        administrateur pour réouvrir votre ticket.
                                                    </div>
                                                </div>
                            ...
                            if (!empty($ticketCommentaires[$tickets['id']])) :
                                for ($i = 0; $i < count($ticketCommentaires[$tickets['id']]); $i++) : ?>
                                    ...
                                    <div class="modal fade"
                                         id="editComm-<?= $ticketCommentaires[$tickets['id']][$i]['id']; ?>"
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="col-lg-12 text-center">
                                                            <div class="row">
                                                                <button type="submit" class="btn btn-main w-100">Valider
                                                                    !
                                                                </button>
                                                            </div>
                                                        </div>
                ...
                <?php else : ?>
                    ...
                    <button data-toggle="collapse" href="#ticketCree" role="button" aria-expanded="false"
                            aria-controls="ticketCree" class="btn btn-reverse w-100 mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea data-UUID="0007" id="ckeditor" name="message"
                                                  style="height: 275px; margin: 0px; width: 100%;"></textarea>
                                    </div>
                                </div>
