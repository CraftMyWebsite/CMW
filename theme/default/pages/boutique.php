        ...
        <div class="row">
            ...
            <div class="d-flex col-12 info-page">
                ...
                <div class="info-content">
                    La boutique permet d'acheter du contenu In-Game depuis le site grâce à de l'argent réel, cela sert à
                    payer l'hébergement du serveur. <br>
                    La monnaie virtuelle utilisée sur la boutique est le "<?= $_Serveur_['General']['moneyName']; ?>",
                    vous pouvez obtenir des <?= $_Serveur_['General']['moneyName']; ?> en échange de dons sur <a
                            href="index.php?page=token"> cette page</a>.
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <ul class="categorie-content nav nav-tabs">
                            <?php if (isset($categories)) : ?>
                                ...
                                <?php for ($j = 0; $j < count($categories); $j++) : ?>
                                    <li class="categorie-item nav-item<?= ($j == 0) ? ' active' : '' ?>">
                                        <a href="#categorie-<?= $j ?>"
                                           class="nav-link categorie-link<?= ($j == 0) ? ' active' : '' ?>"
                                           data-toggle="tab">
                                            <?= $categories[$j]['titre']; ?>
                                        </a>
                                    </li>
                            ...
                            <?php else : ?>
                                <li class="no-hover bg-danger categorie-item nav-item active">
                                    <div href="#categorie-none" class="text-center nav-link categorie-link disabled"
                                         data-toggle="tab">
                            ...
                            <div id="categorie-<?= $j ?>"
                                ...
                                <?php if (!empty($categories[$j]['message'])) : ?>
                                    <div class="info-page">
                                        <div class="text-center"><span
                                                    class="font-weight-bold">Description :</span> <?= $categories[$j]['message']; ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                                ...
                                                <div class="card-footer">
                                                    <?php if (Permission::getInstance()->verifPerm('connect')) : ?>
                                                        <?php if (isset($offresTableau[$i]['buy']) && !isset($_SESSION['bddachat'][$i])) { ?>
                                                            <a href="#" class="btn btn-main disabled" disabled>Vous
                                                                devez d'abord
                                                                acheter: <?php foreach ($offresTableau[$i]['buy'] as $value) {
                                                                    echo $offresByGet[$value];
                                                                } ?></a>
                                                        <?php } else if (isset($offresTableau[$i]['maxbuy'])) { ?>
                                                            <a href="#" class="btn btn-main disabled" disabled>Vous avez
                                                                dépassé le nombre d'achat maximum de cette offre</a>
                                                        <?php } else if ($offresTableau[$i]['nbre_vente'] == 0) { ?>
                                                            <a href="#" class="btn btn-main disabled" disabled>Rupture
                                                                de stock</a>
                                                        <?php } else { ?>
                                                            <a href="index.php?action=addOffrePanier&offre=<?= $offresTableau[$i]['id'] ?>&quantite=1"
                                                               class="btn btn-main">
                                                    ...
                                                    <?php endif; ?>
                                                    <button class="btn btn-main">Prix
                                ...
                                <?php if ($categories[$j]['offres'] == 0) : ?>
                                    ...
                                    <div class="info-page bg-danger">
                                        <div class="text-center">Aucune offre disponible pour la catégorie
                                            : <?= $categories[$j]['titre'] ?> !
                                        </div>
                                    </div>
                                <?php endif; ?>
                    ...
                    <div class="card-body player-shop">
                        ...
                        <div class="categorie-content">
                            <div class="categorie-item text-justify">
                                ...
                                <div class="categorie-item">
                                    <a data-toggle="modal" data-target="#ConnectionSlide" class="btn btn-main"><span
