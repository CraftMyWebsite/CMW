                ...
                <ol class="breadcrumb bg-lightest">
                    ...
                    <?php if (isset($id_sous_forum)) : ?>
                        <li class="breadcrumb-item"><a
                                    href="index.php?page=forum_categorie&id=<?= $id ?>"> <?= $categoried['nom'] ?> </a>
                        </li>
                    <?php else : ?>
                                ...
                                <td>
                                    ...
                                    <?php if ($sousforumd[$a]['img'] == NULL) : ?>
                                        <a style="font-size: 28px;"
                                           href="index.php?page=sous_forum_categorie&id=<?= $id; ?>&id_sous_forum=<?= $sousforumd[$a]['id']; ?>">
                                            <i class="far fa-comment-dots"></i>
                                        </a>
                                    <?php else : ?>
                                        <a style="font-size: 28px;"
                                           href="index.php?page=sous_forum_categorie&id=<?= $id; ?>&id_sous_forum=<?= $sousforumd[$a]['id']; ?>"><i
                                    ...
                                    <td>
                                        <div class="mx-auto d-flex align-self-center">
                                            ...
                                            <div class="dropdown d-inline ml-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                       href="index.php?action=ordreSousForum&ordre=<?= $sousforumd[$a]['ordre']; ?>&id=<?= $sousforumd[$a]['id']; ?>&id_cat=<?= $sousforumd[$a]['id_categorie']; ?>&modif=monter"><i
                                                                class="fas fa-arrow-up"></i> Monter d'un cran</a>
                                                    <a class="dropdown-item"
                                                       href="index.php?action=ordreSousForum&ordre=<?= $sousforumd[$a]['ordre']; ?>&id=<?= $sousforumd[$a]['id']; ?>&id_cat=<?= $sousforumd[$a]['id_categorie']; ?>&modif=descendre"><i
                                            ...
                                            <?php if ($sousforumd[$a]['close'] == 0) : ?>
                                                ...
                                                <a href="index.php?action=lock_sf&id_f=<?= $sousforumd[$a]['id_categorie']; ?>&id=<?= $sousforumd[$a]['id']; ?>&lock=1"
                                            ...
                                            <?php else : ?>
                                                ...
                                                <a href="index.php?action=unlock_sf&id_f=<?= $sousforumd[$a]['id_categorie']; ?> &id=<?= $sousforumd[$a]['id']; ?>&lock=0"
                                            ...
                                            <a class="btn btn-danger no-hover ml-1"
                                               href="index.php?action=remove_sf&id_cat=<?php echo $id; ?>&id_sf=<?php echo $sousforumd[$a]['id']; ?>"><i
                                ...
                                <td>
                                    <a href="?page=profil&profil=<?= $topicd[$i]['pseudo']; ?>">
                                        <img src="<?= $_ImgProfil_->getUrlHeadByPseudo($topicd[$i]['pseudo'], 42); ?>"
                                             ...
                                             alt="avatar de l'auteur <?= $_Joueur_['pseudo']; ?>"
                ...
                <nav aria-label="Page forum catégorie">
                    <ul class="pagination">
                        ...
                        for ($i = 1; $i <= $count_topic_nbrOfPages2; $i++) : ?>
                            <li class="page-item">
                                <a class="page-link"
                                   href="index.php?page=<?= (isset($id_sous_forum)) ? 'sous_' : ''; ?>forum_categorie&id=<?= $id ?><?= (isset($id_sous_forum)) ? "&id_sous_forum=$id_sous_forum" : ''; ?>&page_topic=<?= $i; ?>">
                                    <?= $i; ?>
                                </a>
                            </li>
                        <?php endfor; ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 text-center">
                                <textarea data-UUID="0003" id="ckeditor" name="contenue"
                                          style="height: 350px; margin: 0px; width: 100%;"></textarea>
