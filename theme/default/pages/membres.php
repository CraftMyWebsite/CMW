        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 mb-3">
                <div class="form-group row searchPlayer">
                    <label for="searchPlayer" class="col-lg-4 col-md-12 col-sm-12 col-form-label">Rechercher un joueur
                        : </label>
                    <input type="text" onChange="rechercheAjaxMembre();"
                           class="form-control col-lg-8 col-md-12 col-sm-12" id="recherche" name="searchPlayer"
                           placeholder="Ex: BadiiiX (Appuyez sur Entrée pour valider)"/>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <table class="table table-dark table-striped table-hover">
                    ...
                    <?php foreach ($membres as $value) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="index.php?page=profil&profil=<?= $value['pseudo']; ?>" class="btn btn-reverse">Voir
                                    le compte</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        if ($page + 5 < $Membres->nbPages) : ?>
                            <li class="page-item">
                                <a class="page-link" href="index.php?page=membres&page_membre=<?= $Membres->nbPages ?>"
                                   aria-label="Suivant">
