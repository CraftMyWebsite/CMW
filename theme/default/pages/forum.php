    ...
    <div class="container-fluid col-md-9 col-lg-9 col-sm-10">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                                 <span onclick="searchForum(document.getElementById('search-topic').value, document.getElementById('all-search'), document.getElementById('table-search'),document.getElementById('title-search'))"
                                       style="border: none;" class="input-group-text btn btn-main"
        ...
        <div class="row">
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'modeJoueur')) : ?>
                <p class="text-center">
                    <a href="index.php?action=mode_joueur" class="btn btn-main w-100">Passer en mode
                        visuel <?= ($_SESSION['mode']) ? 'Administrateur' : 'Joueur'; ?></a>
                </p>
            <?php endif; ?>
                        ...
                        <div class="row ml-auto">
                            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'deleteForum') and !$_SESSION['mode']) : ?>
                                ...
                                <div>
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <form action="?action=modifPermsForum" method="POST">
                                                ...
                                                <button type="submit" class="dropdown-item text-center">Modifier
                                                </button>
                                            </form>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <?php if ($i != 0) { ?>
                                                    <a class="dropdown-item"
                                                       href="index.php?action=ordreForum&ordre=<?= $fofo[$i]['ordre']; ?>&id=<?= $fofo[$i]['id']; ?>&modif=monter">
                                                        <i class="fas fa-arrow-up"></i> Monter d'un cran
                                                    </a>
                                                <?php }
                                                if ($i != count($fofo) - 1) { ?>
                                                    <a class="dropdown-item"
                                                       href="index.php?action=ordreForum&ordre=<?= $fofo[$i]['ordre']; ?>&id=<?= $fofo[$i]['id']; ?>&modif=descendre">
                                    ...
                                    <a href="index.php?action=remove_forum&id=<?php echo $fofo[$i]['id']; ?>"
                            ...
                            <th colspan="5"
                                ...
                                <h5 class="text-center"
                                    ...
                                    <span style="display:inline;"><?= ucfirst($fofo[$i]['nom']); ?></span> <input
                                            ...
                                            style="width:50%;color:white;display:none;background: transparent;border: none;">
                                ...
                                <tr>
                                                    ...
                                                    <?php if (count($sousforum) != '0') : ?>
                                                        <div class="dropdown-menu"
                                                            ...
                                                            <?php for ($s = 0; $s < count($sousforum); $s++) : ?>
                                                                <a class="dropdown-item"
                                                                   href="index.php?page=sous_forum_categorie&id=<?= $categorie[$j]['id']; ?>&id_sous_forum=<?= $sousforum[$s]['id']; ?>">
                                                                    <?= $sousforum[$s]['nom']; ?>
                                                                </a>
                                                            <?php endfor; ?>
                                                        </div>
                                    ...
                                    <td class="text-center">
                                        <?php if ($derniereReponse) : ?>
                                            <a href="index.php?page=post&id=<?= $derniereReponse['id']; ?>"
                                        ...
                                        <td>
                                            <div class="mx-auto d-flex align-self-center">
                                                ...
                                                <?php if (count($categorie) > 1) { ?>
                                                    <div class="dropdown d-inline ml-1">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <?php if ($j != 0) { ?>
                                                                <a class="dropdown-item"
                                                                   href="index.php?action=ordreCat&ordre=<?= $categorie[$j]['ordre']; ?>&id=<?= $categorie[$j]['id']; ?>&forum=<?= $categorie[$j]['forum']; ?>&modif=monter">
                                                                    <i class="fas fa-arrow-up"></i> Monter d'un cran
                                                                </a>
                                                            <?php }
                                                            if ($j != count($categorie) - 1) { ?>
                                                                <a class="dropdown-item"
                                                                   href="index.php?action=ordreCat&ordre=<?= $categorie[$j]['ordre']; ?>&id=<?= $categorie[$j]['id']; ?>&forum=<?= $categorie[$j]['forum']; ?>&modif=descendre">
                                                                    <i class="fas fa-arrow-down"></i> Descendre d'un
                                                                    cran
                                                                </a>
                                                            <?php } ?>
                                                        </div>
                                                ...
                                                <?php if ($categorie[$j]['close'] == 0) : ?>
                                                    ...
                                                    <a href="index.php?action=lock_cat&id=<?= $categorie[$j]['id']; ?>&lock=1"
                                                ...
                                                <?php else : ?>
                                                    ...
                                                    <a href="index.php?action=unlock_cat&id=<?= $categorie[$j]['id']; ?>&lock=0"
                                                ...
                                                <a href="index.php?action=remove_cat&id=<?= $categorie[$j]['id']; ?>"
        ...
        <div class="row">
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'addForum') and !$_SESSION['mode']) : ?>
                ...
                <a class="btn btn-reverse no-hover col-5 mr-auto" role="button" data-toggle="collapse" href="#add_forum"
            ...
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'addCategorie') and !$_SESSION['mode']) : ?>
                ...
                <a class="btn btn-reverse no-hover col-5 ml-auto" role="button" data-toggle="collapse"
