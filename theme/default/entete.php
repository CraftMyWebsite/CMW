...
<header>
    <div class="header-content"
         style="background: linear-gradient(to bottom, rgba(77, 77, 77, 0.52), rgba(68, 68, 68, 0.73)), url('theme/upload/bg.png') center;">
                    ...
                    for ($i = 0; $i < count($_Menu_); $i++) {
                        if (isset($_Menu_[$i]['list'])) { ?>
                            <li class="nav-item dropdown">
                                <a id="Listdefil<?php echo $i; ?>" class="nav-link dropdown-toggle" href="#"
                                   id="dropdown-tools" role="button" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false"><?php echo $_Menu_[$i]['name']; ?></a>
                    ...
                    <?php if ($banned == false) : ?>
                        <?php if (Permission::getInstance()->verifPerm('connect')) : //Si nous avons un joueur connecté
                            ...
                            <li class="nav-item dropdown ml-auto">
                                ...
                                <a id="profil-<?= $_Joueur_['pseudo']; ?>" class="nav-link dropdown-toggle btn btn-main"
                                   href="#" id="dropdown-tools" role="button" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu" aria-labelledby="profil-<?= $_Joueur_['pseudo']; ?>">
                                    ...
                                    <?php endif; ?>
                                    <a class="dropdown-item" href="index.php?page=alert"><i class="fa fa-bell"></i>
                        ...
                        <?php else : //Si nous avons un invité
                            ...
                            <li class="nav-item dropdown ml-auto">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item hvr-forward" href="#" data-toggle="modal"
                        ...
                        <div class="row">
                            <?php if (!empty($_Serveur_['General']['ipTexte'])) { ?>
                                <div class="py-3 mr-3 mb-3 col-md-12 col-sm-12 col-lg-7 d-flex align-self-center alert alert-main">
                                    ...
                                    <button class="btn btn-light copy-ip ml-auto" onclick="copierIP();" type="button">
                                        Copier l'ip !
                                    </button>
                                    <input type="text" style="position:absolute;top:0;left:0;z-index:-9999;"
                                           id="iptexte" value="<?= $_Serveur_['General']['ipTexte']; ?>">
                                </div>
                            <?php }
                            ?>
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">
                                        ...
                                        <?php elseif ($_Serveur_['General']['statut'] == 1 && $servEnLigne == true) : ?>
                                            ...
                                            <div class="card-text">Nombres de Joueurs :
                                                <strong><?= $playeronline ?></strong>/<?= $maxPlayers; ?></div>
                                        <?php else : ?>
                ...
                <div class="header-text">
                    <div class="text-right">
                        ...
                        <?php elseif (isset($_GET['page']) && isset($_GET['profil']) && $_GET['page'] == 'profil') : //Si c'est la page de profile
                            ?>
                            <h1 class="text-uppercase"><?= htmlentities($_GET['page']) ?>
                                de <?= htmlentities($_GET['profil']) ?></h1>

                            <!-- Partie Forum -->
                        <?php elseif (isset($_GET['page']) && $_GET['page'] == 'editForum') : //Si c'est la page d'édition de forum
                            ?>
                            <h1 class="text-uppercase"> Edition
                                d'<?= ($_GET['objet'] == 1) ? 'un topic' : 'une réponse'; ?> </h1>
