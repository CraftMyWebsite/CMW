...
<div class="container">
    ...
    <div class="py-5 text-center">
        ...
        <p class="lead">
            Merci d’avoir choisi CraftMyWebsite, des mises à jour seront disponibles très fréquemment sur le site
            officiel.
            Il peut néanmoins y avoir des bugs ! Merci de nous en faire part sur le forum ou sur le discord pour les
            ...
            <div class="col-md-12">
                <div class="wrapper-progressBar">
                    <ul class="progressBar">
                        ...
                        <li <?php if ($installEtape >= 3) echo 'class="active"'; ?>><span class="d-none d-md-block">Création d'un compte Administrateur</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="pt-3">
            <div class="alert alert-danger">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <btn onclick="$('#htaccessModal').modal('show')" class="btn btn-danger btn-block minecrafter">
                            Forcer l'installation</btn>
                    </div>
                </div>
            </div>
        </div>
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            ...
                            <small class="text-muted">
                                ...
                                if ($return['nginx']) {
                                    ?>
                                    <b>NGINX <a href="#nginx" class="btn-outline-info" data-toggle="popover"
                                                data-placement="top" title="Aide > Nginx / Apache"
                                                data-content="Nous avons détecté que vous utilisez NGINX, CraftMyWebsite ne fonctionne pas sous NGINX ou difficilement. Si vous êtes sur Apache vous pouvez continuez l'installation"><i
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            ...
                            <small class="text-muted">zip, version: <?= phpversion('zip'); ?>
                                <span>
                            ...
                            <small class="text-muted">pdo, version: <?= phpversion('pdo'); ?>
                                <span>
                                            <?php if (extension_loaded('pdo') == true) { ?>
                                                <i class="text-success fas fa-check-circle"></i>
                                            <?php }else{ ?>
                                                <i class="text-danger fas fa-minus-circle"></i>
                                            <?php } ?>
                            ...
                            <small class="text-muted">curl, version: <?= phpversion('curl'); ?>
                                <span>
                    ...
                    <li class="list-group-item d-flex justify-content-between bg-light lh-condensed">
                        <div>
                            ...
                            <small class="text-muted">
                                <span class="bold">Hôte:</span>  <?= php_uname('n'); ?>
                            </small><br />
