...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.$container = $('<div class="bootstrap-tagsinput bg-white form-control"></div>');
    this.$input = $('<input type="' + this.type + '" style="display:none;" placeholder="' + this.placeholderText + '"/>').appendTo(this.$container);
