        ...
        <div class="modal-content">
            <div class="modal-body">
                <p>
                    ...
                    <div class="alert alert-danger">
                        Il semble que vous essayez d'installer le CMS sur une base de donnée qui n'est pas vide <strong> et qui contient des données du CMS</strong> ! Cela peut entrainer des conflits majeurs et fausser l'installation !
                        <br/>
                    </div>
                </p>
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="?dropSQL=true" class="btn btn-success btn-block minecrafter">Vider la base et forcer l'installation (Recommandé) <strong>[Irréversible]</strong></a>
                    </div>
                    <div class="col-md-4">
