	        	...
	        	<?php
	        		foreach($membres as $value)
	        		{
	        			?><tr>
	        				...
	        				<td><a href="?page=profil&profil=<?=$value['pseudo'];?>" style="color: inherit;"><img src='<?=$_ImgProfil_->getUrlHeadByPseudo($value['pseudo']);?>' style='width: 32px; height: 32px;' alt='Profil' /> <?=$value["pseudo"];?></a></td>
