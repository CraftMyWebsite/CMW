<div class="cmw-page-content-header"><strong>Gestion</strong> - Gérez vos tickets support</div>
        <?php if(!Permission::getInstance()->verifPerm('PermsPanel', 'support', 'tickets', 'actions', 'editEtatTicket') AND !Permission::getInstance()->verifPerm('PermsPanel', 'support', 'tickets', 'actions', 'deleteTicket')) { ?><div class="row">
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <?php if(Permission::getInstance()->verifPerm('PermsPanel', 'support', 'tickets', 'actions', 'deleteTicket')) { ?>
                                    <th style="text-align: center;">Supprimer</th>
                                <?php }
                                if(Permission::getInstance()->verifPerm('PermsPane', 'support', 'tickets', 'actions', 'editEtatTicket')) { ?>
